...
public class IfExample {
	public static void main(String[] args) {
		...
		if(kor<0 || kor>100 || eng<0 || eng>100 || mat<0 || mat>100) {//비정상적인 입력값인 경우
			System.out.println("[에러]0~100 범위을 벗어난 비정상적인 점수가 입력 되었습니다.");
			System.exit(0);
		}
		*/
		...
		if(kor<0 || kor>100) {
			System.out.println("[에러]0~100 범위을 벗어난 비정상적인 국어점수가 입력 되었습니다.");
			//System.exit(0);
			valid=true;
		}
		
		if(eng<0 || eng>100) {
			System.out.println("[에러]0~100 범위을 벗어난 비정상적인 영어점수가 입력 되었습니다.");
			//System.exit(0);
			valid=true;
		}
		
		if(mat<0 || mat>100) {
			System.out.println("[에러]0~100 범위을 벗어난 비정상적인 수학점수가 입력 되었습니다.");
			//System.exit(0);
			valid=true;
		}		
		
		if(valid) {//입력값 검증이 실패된 경우
			System.exit(0);
		}
