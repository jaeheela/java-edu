...
//일반적으로 연산자는 왼쪽에서 오른쪽으로 처리되지만 단항 연산자와 대입 연산자는 오른쪽에서 왼쪽으로 처리
// ex) 10+20+30       a=b=c   
//     -------->     <-----
...
public class OperatorApp {
	public static void main(String[] args) {
		...
		//비교(관계) 연산자 : 값(객체)을 비교하여 false(거짓) 또는 true(참) 중 하나의 결과를 제공하는 연산자
		...
		// => Bit 논리 연산자 : 정수값을 Bit 단위로 계산하기 위한 연산자 - &(논리곱) , ^(배타적 논리합), |(논리합)  
		...
		System.out.println("c < 10 || c > 30 = "+(c<10 || c>30));
		System.out.println("===============================================================");
		//대입 연산자 : 왼쪽 피연산자(변수)에 값을 저장하기 위한 연산자 - 무조건 마지막에 실행
		// => 순수 대입 연산자 : 값을 변수에 저장 - =
		...
		// => 조건식?참값:거짓값 - 조건식의 결과가 true인 경우 참값을 사용하고 false인 경우 거짓값 제공
