...
// => IPV6 - 128Bit를 이용하여 IP 주소 표현 : 16진수 0000~FFFF 범위의 정수값 8개로 [:]으로 구분하여 표현 
...
// => A Class(255.0.0.0 - 16,777,216 : 0.X.X.X~127.X.X.X), B Class(255.255.0.0 - 65,536 : 128.X.X.X~191.X.X.X)
//, C Class(255.255.255.0 - 256 : 192.X.X.X~233.X.X.X) 등
