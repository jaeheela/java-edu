...
//예외(Exception) : 사용자에 의해 프로그램이 잘못 실행하거나 프로그램이 잘못 개발되어 실행된
//경우 발생되는 프로그램 오류
// => 프로그램 실행시 예외가 발생된 경우 예외가 발생된 지점에서 프로그램 강제 종료
...
// => try 블럭에서 발생된 예외 관련 객체를 catch 블럭으로 전달해서 참조변수에 저장
...
public class ExceptionHandleApp {
	public static void main(String[] args) {
		...
		try {
			...
			// => 실행 예외는 예외 발생시 JVM에 의해 자동으로 예외처리 되어 메세지를 제공받아 출력 - 개발자 중심
