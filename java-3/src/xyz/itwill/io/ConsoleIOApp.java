...
public class ConsoleIOApp {
	public static void main(String[] args) throws IOException {
		//Java에서 기본적으로 제공되는 키보드 입력스트림(System.in)을 InputStreamReader 객체의
		//입력스트림으로 확장하여 문자데이타를 입력받을 수 있도록 설정하고 BufferedReader 객체의
		//입력스트림으로 확장하여 대량의 문자데이타를 입력 받을 수 있도록 설정
