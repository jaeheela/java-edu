...
//JSP 문서(템플릿 페이지)로 응답하기 위한 기능을 제공하는 뷰프로그램 - ViewResolver
...
//응답 처리되도록 Spring Bean Configuration File 설정 - servlet-context.xml
// => 기존의 ViewName을 JSP 문서로 변환하여 응답한 InternalResourceViewResolver보다 먼저 실행되도록 설정
