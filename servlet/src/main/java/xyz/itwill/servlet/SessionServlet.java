...
//세션 트렉킹(Session Tracking) : [JSESSIONID] 이름의 쿠키값을 서버에 존재하는 세션의 아이디와
//비교하여 검색하는 작업 
...
public class SessionServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// => 기존 세션에 저장된 값과 같은 이름의 속성명을 사용하여 경우 속성값 변경
		...
		session.setAttribute("now", new Date());//다른 웹프로그램에서 객체를 사용할 수 있도록 공유
